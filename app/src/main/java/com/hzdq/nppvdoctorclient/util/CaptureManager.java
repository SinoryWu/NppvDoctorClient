...
public class CaptureManager {
    ...
    public CaptureManager(Activity activity, DecoratedBarcodeView barcodeView, MainViewModel mainViewModel) {
    ...
    protected void returnResult(BarcodeResult rawResult) {
        mainViewModel.getScanSn().setValue(rawResult.toString());
        mainViewModel.isScanSn().setValue(1);
